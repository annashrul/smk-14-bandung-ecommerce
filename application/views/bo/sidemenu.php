    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview <?=array_search($page, $side_menu)?'active':null?>" <?php (((int)substr($access->access,51,20))==0)?'style="display:none;"':null?>>
                ...
                <ul class="treeview-menu">
                    <li class="<?=$page=='data_stok'?'active':null?>" <?php (substr($access->access,51,1)!=1)?'style="display:none;"':null?>><a href="<?=base_url().'inventory/data_stok'?>"><i class="glyphicon glyphicon-equalizer"></i> Data Stok</a></li>
